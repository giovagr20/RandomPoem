...
import co.com.poem.generator.PoemGeneratorRandom.domain.utilities.GrammarEnum;
        ...
        try {
            ...
            for (int position = 0; position < grammarValues.length; position++) {
                ...
                if (grammar.getMainRule() == null) {
                    ...
                    List<String> ruleReferenceKeyword = Arrays.asList(ruleWordreferences.get(indexReferenceKeyword).trim().split("\\|"));
